...
public class UpdaterDialogHandler
{
    ...
    Updater.OnCheckForUpdateFinishedListener mOnCheckForUpdateFinishedListener = new PodzhigatelUpdater.OnCheckForUpdateFinishedListener()
    {
        @Override
    ...
    Updater.OnUpdateProgressListener mOnUpdateProgressListener = new PodzhigatelUpdater.OnUpdateProgressListener()
    {
        @Override
