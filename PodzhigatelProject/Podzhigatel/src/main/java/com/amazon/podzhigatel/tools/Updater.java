package com.amazon.podzhigatel.tools;
...
import com.amazon.podzhigatel.gui.UpdaterDialogHandler;
...
public abstract class Updater
{
    ...
    private String mDownloadFolder = "PodzhigatelUpdates";;
        ...
        Thread checkForUpdateThread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    Log.d(PodzhigatelUpdater.class.getName(), "Check for update finished successful, found version: " + getLatestVersion());
                }
                catch (Exception e)
                {
                    Log.d(PodzhigatelUpdater.class.getName(), "Update-Check-Error: " + e.getMessage());
        ...
        Thread updateThread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    if (mIsBusy)
                    {
                        throw new Exception("PodzhigatelUpdater is already working..");
                    }
                    ...
                    Log.d(PodzhigatelUpdater.class.getName(), "Download from URL: " + apkUrl);
                    ...
                    Log.d(PodzhigatelUpdater.class.getName(), "Download to file://" + downloadFile.getAbsolutePath());
                    ...
                    context.registerReceiver(new BroadcastReceiver()
                    {
                        public void onReceive(Context context, Intent intent)
                        {
                            ...
                            Log.d(PodzhigatelUpdater.class.getName(), "Received intent: " + action);
                            ...
                            Log.d(PodzhigatelUpdater.class.getName(), "Release semaphore..");
                            mUpdateSemaphore.release();
                        }
                    }, new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));

                    Log.d(PodzhigatelUpdater.class.getName(), "Aquire semaphore");
                    mUpdateSemaphore = new Semaphore(1);
                    mUpdateSemaphore.acquire();

                    // Here the download is performed
                    Log.d(PodzhigatelUpdater.class.getName(), "Start download");
                    mDownloadManager = (DownloadManager)context.getSystemService(context.DOWNLOAD_SERVICE);
                    mQueueValue = mDownloadManager.enqueue(localRequest);

                    Log.d(PodzhigatelUpdater.class.getName(), "Aquire semaphore again");
                    ...
                    Log.d(PodzhigatelUpdater.class.getName(), "Download finished");
                ...
                {
                    Log.d(PodzhigatelUpdater.class.getName(), "UpdateError: " + e.getMessage());
