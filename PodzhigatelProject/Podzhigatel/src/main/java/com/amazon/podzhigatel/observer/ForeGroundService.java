...
import com.amazon.podzhigatel.gui.AppActivity;
import com.amazon.podzhigatel.gui.MainActivity;
        ...
        public void onServiceError(final String message)
        {
            ForeGroundService.this.runOnUiThread(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    {
                        Toast.makeText(ForeGroundService.this, "Podzhigatel: " + message, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
        ...
        TimerTask timerTask = new TimerTask()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    podzhigatelUpdater.checkForUpdate(true);
                    AppActivity.LATEST_APP_VERSION = podzhigatelUpdater.getLatestVersion();
                }
                catch(Exception e)
                {
