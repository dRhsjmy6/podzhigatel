package com.amazon.podzhigatel.gui;
...
import com.amazon.podzhigatel.R;
import com.amazon.podzhigatel.tools.AppInfo;
import com.amazon.podzhigatel.tools.AppStarter;
import com.amazon.podzhigatel.tools.PodzhigatelUpdater;
import com.amazon.podzhigatel.tools.SettingsProvider;
import com.amazon.podzhigatel.tools.Tools;

import static com.amazon.podzhigatel.gui.AppSettingsOverlayDialog.*;
...
public class AppActivity extends CustomFragment
{
    ...
    /** Latest Podzhigatel version found */
        ...
        mGridView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
        {
            ...
            public void onGlobalLayout()
            {
                try
                {
                    ...
                    PodzhigatelUpdater podzhigatelUpdater = new PodzhigatelUpdater();
                    if(!mSettings.getHaveUpdateSeen() && podzhigatelUpdater.isVersionNewer(Tools.getCurrentAppVersion(getActivity()), LATEST_APP_VERSION))
                    {
                        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());

                        builder.setTitle("Podzhigatel " + LATEST_APP_VERSION);
                        builder.setMessage("There is a new version of Podzhigatel, do you want to update?");
