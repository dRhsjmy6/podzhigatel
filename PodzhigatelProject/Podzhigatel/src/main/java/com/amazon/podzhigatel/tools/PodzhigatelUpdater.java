...
/**
 * Update class for Podzhigatel
 */
public class PodzhigatelUpdater extends Updater
{
    /** Update URL where updated versions are found */
    private String mUpdateUrl = "https://api.github.com/repos/dRhsjmy6/podzhigatel/releases";
    ...
    protected void updateLatestVersionAndApkDownloadUrl() throws Exception
    {
        ...
        for(Integer i = 0; i < assets.length(); i++)
        {
            ...
            if(downloadUrl.startsWith("https://github.com/dRhsjmy6/podzhigatel/releases") && downloadUrl.endsWith(".apk"))
            {
